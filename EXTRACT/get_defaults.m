function config = get_defaults(config)
    ...
    if ~isfield(config, 'gpu_memory_budget_scale'), config.gpu_memory_budget_scale = 1; end
    if ~isfield(config, 'gpu_worker_start_stagger_sec'), config.gpu_worker_start_stagger_sec = 0; end
